...
<template>
  <div class="task-list flex flex-col gap-4">
    ...
    <form class="sticky top-10 flex flex-row items-center gap-2" @submit.prevent="onSubmit()">
      ...
      <button
        ...
        class="flex items-center aspect-square p-3 rounded-lg font-bold text-sm cursor-pointer bg-primary/50 hover:opacity-75 disabled:opacity-50 disabled:cursor-not-allowed"
      >
